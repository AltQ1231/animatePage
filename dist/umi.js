(function(e) {
  ...
  '8XRh': function(e, t, n) {
    ...
    var v = h(Object(p['a'])(), 'undefined' !== typeof window ? window : {}),
      y = {};
    if (Object(p['a'])()) {
    ...
    var L = Object(p['a'])() ? u['useLayoutEffect'] : u['useEffect'],
      D = L,
      F = n('wgJM'),
      U = function() {
        var e = u['useRef'](null);
    ...
    var q = function(e, t) {
      ...
      V = function(e) {
        ...
        function o(e) {
          e && (e.removeEventListener(k, r), e.removeEventListener(S, r));
        }
        function i(e) {
    ...
    function K(e, t, n, a) {
      ...
      (ae.current = ye),
        ...
        Object(u['useEffect'])(
          function() {
            void 0 !== B && Q === T && (null === L || void 0 === L || L(B));
          },
          [B, Q],
        );
      var me = X;
      return (
        fe[A] && ve === I && (me = Object(o['a'])({ transition: 'none' }, me)),
    ...
    function X(e) {
      ...
      var s = u['forwardRef'](function(e, t) {
        ...
        function E() {
          try {
            return Object(c['a'])(w.current || x.current);
          } catch (e) {
            return null;
          }
        }
        ...
        var M,
          N = u['useCallback'](function(e) {
            (w.current = e), Object(l['a'])(_.current, e);
          }, []),
          L = Object(o['a'])(Object(o['a'])({}, g), {}, { visible: s });
        if (v)
          if (C !== T && n(e)) {
            var D, F;
            j === A
                ...
                Object(o['a'])(
                  ...
                  {},
                  {
                    className: f()(
                      O(y, C),
                      ((D = {}),
                      Object(r['a'])(D, O(y, ''.concat(C, '-').concat(F)), F),
        ...
        return u['createElement'](J, { ref: x }, M);
      });
        ...
        for (var t = !1, a = r; a < i; a += 1) {
          ...
          if (c.key === e.key) {
            r < a &&
              ...
              (r = a)),
              n.push(Object(o['a'])(Object(o['a'])({}, c), {}, { status: re })),
              (r += 1),
              (t = !0);
            break;
          }
        }
        t || n.push(Object(o['a'])(Object(o['a'])({}, e), {}, { status: oe }));
      }),
        r < i &&
          (n = n.concat(
            u.slice(r).map(function(e) {
              return Object(o['a'])(Object(o['a'])({}, e), {}, { status: ne });
            }),
          ));
      var c = {};
  ...
  AJpP: function(e, t, n) {
    ...
    function q(e) {
      ...
      for (var u = 1; u <= U; u += 1) {
        var c = r.toHsv(),
          l = new I({ h: z(c, u), s: H(c, u), v: W(c, u) }).toHexString();
        n.push(l);
      }
      return 'dark' === t.theme
        ? B.map(function(e) {
  ...
  TeRw: function(e, t, n) {
    ...
    function O(e, t) {
      var n = function() {
        ...
        function f(i) {
          var a = i.prefixCls,
            u = n('notification', a);
          e(o()(o()({}, i), { prefixCls: u }), function(e) {
            var n = e.prefixCls,
              o = e.instance;
            (r = o), l(t(i, n));
          });
        ...
        return (
          ...
          ['success', 'info', 'warning', 'error'].forEach(function(e) {
            p.current[e] = function(t) {
              return p.current.open(o()(o()({}, t), { type: e }));
            };
          }),
          [
            p.current,
            u['createElement'](k['a'], { key: 'holder' }, function(e) {
    ...
    var F = { success: h.a, info: w.a, error: y.a, warning: g.a };
    function U(e, t) {
      ...
      e.icon
        ...
        : e.type &&
          (r = u['createElement'](F[e.type] || null, {
            className: ''
              .concat(t, '-icon ')
              .concat(t, '-icon-')
              .concat(e.type),
    ...
    ['success', 'info', 'warning', 'error'].forEach(function(e) {
      z[e] = function(t) {
        return z.open(o()(o()({}, t), { type: e }));
      };
    }),
      (z.warn = z.warning),
      (z.useNotification = O(D, U));
    t['a'] = z;
  },
  TfTi: function(e, t, n) {
    'use strict';
  ...
  sEfC: function(e, t, n) {
    ...
    function l(e, t, n) {
      ...
      function b(t) {
        var n = l,
          r = s;
        return (l = s = void 0), (v = t), (p = e.apply(r, n)), p;
      }
      function w(e) {
        return (v = e), (d = setTimeout(S, t)), y ? b(e) : p;
      }
      function x(e) {
        var n = e - h,
          r = e - v,
      ...
      function k(e) {
        return (d = void 0), g && l ? b(e) : ((l = s = void 0), p);
      }
      function O() {
        void 0 !== d && clearTimeout(d), (v = 0), (l = h = s = d = void 0);
      }
      function T() {
      ...
      function C() {
        ...
        if (((l = arguments), (s = this), (h = e), n)) {
          ...
          if (m) return clearTimeout(d), (d = setTimeout(S, t)), b(h);
        }
  ...
  tB8F: function(e, t, n) {
    ...
    function c(e) {
      var t = e.matchedRoutes;
      if (t.length) {
        var n = t[t.length - 1].route.title || '\u8f66\u95f4\u770b\u677f';
        (document.title = n), localStorage.setItem('title', n);
      }
    }
    var l = n('q1tI'),
      s = n.n(l),
      f = n('YS25'),
      p = { basename: '/' };
    window.routerBase && (p.basename = window.routerBase);
    var d = Object({ NODE_ENV: 'production' }).__IS_SERVER
        ? null
        : Object(f['a'])(p),
      h = function() {
        var e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
        return e || (d = Object(f['a'])(p)), d;
      },
      v = n('ODXe'),
      y = n('aUsF'),
      m = n.n(y),
      g = n('FMtG');
    function b(e, t) {
      var n = Object(l['useContext'])(g['UmiContext']),
        r = Object(l['useRef'])(t);
      r.current = t;
      var o = Object(l['useState'])(() =>
    ...
    n('o0o1'), n('HaE+'), n('Ff2n'), n('VTBJ'), n('io9h'), n('tsqr'), n('TeRw');
    var w = n('9/5/'),
      x = n.n(w),
      E = n('hKI/'),
      S = n.n(E);
    ...
    var A = !1;
    if ('undefined' !== typeof window && window.addEventListener && !A) {
      var I = function() {
        if (k() && O())
    ...
    var L = !1;
    if ('undefined' !== typeof window && window.addEventListener && !L) {
      var D = function() {
        if (k())
      ...
      window.addEventListener('visibilitychange', D, !1), (L = !0);
    }
    var F = N,
      U = function() {
        return (
    ...
    (function() {
      function e(e, t, n, r) {
        (this.count = 0),
          ...
          (this.config = t),
          (this.subscribe = n),
          r && (this.state = U(U({}, this.state), r)),
          (this.debounceRun = this.config.debounceInterval
            ? x()(this._run, this.config.debounceInterval)
            : void 0),
      ...
      (e.prototype.setState = function(e) {
            ...
            this.service
              ...
              ['finally'](function() {
                if (
                  ...
                  if (!k() && !e.config.pollingWhenHidden)
        ...
        (e.prototype.run = function() {
          ...
          return this.debounceRun
            ? (this.debounceRun.apply(this, z(e)), Promise.resolve(null))
            : this.throttleRun
            ? (this.throttleRun.apply(this, z(e)), Promise.resolve(null))
            : this._run.apply(this, z(e));
        }),
        ...
        (e.prototype.refresh = function() {
          return this.run.apply(this, z(this.state.params));
        }),
    ...
    var H = s.a.createContext({});
    H.displayName = 'UseRequestConfigContext';
    var W = H;
    var q;
    W.Provider;
    (function(e) {
    ...
    var V = e => {
      ...
      return (
        ...
        c && !n.current ? r.loading || null : t
      );
    };
    function K(e) {
      return s.a.createElement(V, null, e);
    }
    ...
    function ne(e) {
      return s.a.createElement(te, null, e);
    }
    u.register({
      apply: r,
      path: 'C:/Users/lz114/Desktop/animatePage/src/app.tsx',
    }),
      u.register({ apply: o, path: '../plugin-initial-state/runtime' }),
      u.register({ apply: i, path: '../plugin-model/runtime' });
    var re = n('zlVK'),
      oe = n('pVnL'),
      ie = n.n(oe),
      ae = n('lSNA'),
    ...
    function ke(e, t, n) {
      return Se(e)
        ? l['cloneElement'](e, 'function' === typeof n ? n(e.props || {}) : n)
        : t;
    }
    function Oe(e, t) {
      return ke(e, e, t);
    ...
    var Te = function(e, t) {
      ...
      Ce = (Ee('small', 'default', 'large'), null);
    function je(e, t) {
      var n = t.indicator,
        r = ''.concat(e, '-dot');
      return null === n
        ? null
        : Se(n)
        ? Oe(n, { className: me()(n.props.className, r) })
        : Se(Ce)
        ? Oe(Ce, { className: me()(Ce.props.className, r) })
        : l['createElement'](
            'span',
            { className: me()(r, ''.concat(e, '-dot-spin')) },
            l['createElement']('i', { className: ''.concat(e, '-dot-item') }),
            l['createElement']('i', { className: ''.concat(e, '-dot-item') }),
            l['createElement']('i', { className: ''.concat(e, '-dot-item') }),
            l['createElement']('i', { className: ''.concat(e, '-dot-item') }),
          );
          ...
          (r.renderSpin = function(e) {
            var t,
              ...
              y = me()(
                v,
                ((t = {}),
                ue()(t, ''.concat(v, '-sm'), 'small' === c),
                ue()(t, ''.concat(v, '-lg'), 'large' === c),
                ue()(t, ''.concat(v, '-spinning'), h),
                ue()(t, ''.concat(v, '-show-text'), !!s),
                ue()(t, ''.concat(v, '-rtl'), 'rtl' === o),
                t),
                u,
              ),
              m = Object(ge['a'])(d, ['spinning', 'delay', 'indicator']),
              g = l['createElement'](
                'div',
                ie()({}, m, { style: p, className: y }),
                je(v, r.props),
                s
                  ? l['createElement'](
                      'div',
            ...
            if (r.isNestedPattern()) {
              ...
              return l['createElement'](
                'div',
                ie()({}, m, {
                  className: me()(''.concat(v, '-nested-loading'), f),
                }),
                h && l['createElement']('div', { key: 'loading' }, g),
                l['createElement'](
                  'div',
        ...
        fe()(
          ...
          [
            ...
            },
            {
              key: 'render',
              value: function() {
                return l['createElement'](xe['a'], null, this.renderSpin);
              },
            },
          ],
          [
    ...
    Re.defaultProps = { spinning: !0, size: 'default', wrapperClassName: '' };
    var Ae = Re,
      Ie = () =>
        s.a.createElement(
          'div',
          { className: 'nothing-page' },
      ...
      var e = [
        {
          ...
          component: Object(a['dynamic'])({
            loader: () =>
              Promise.all([n.e(4), n.e(0)]).then(n.bind(null, '+ego')),
            loading: Ie,
          }),
          name: 'homepage',
          title: '\u9996\u9875',
          routes: [
            { exact: !0, path: '/', redirect: '/main', title: '\u9996\u9875' },
            {
              exact: !0,
              path: '/main',
              component: Object(a['dynamic'])({
                loader: () => n.e(2).then(n.bind(null, 'jLwg')),
                loading: Ie,
              }),
              name: 'homepage',
              title: '\u9996\u9875',
            ...
            {
              component: Object(a['dynamic'])({
                loader: () => n.e(1).then(n.bind(null, 'i6+/')),
                loading: Ie,
              }),
              exact: !0,
            },
    ...
    var Me = function() {
        ...
        return u.applyPlugins({
          ...
          initialValue: () => {
            ...
            return Object(re['renderClient'])(t);
          },
          args: e,
        });
      },
  ...
  yl30: function(e, t, n) {
    ...
    function G(e) {
      return (
        !!q.call(K, e) ||
        (!q.call(V, e) && (W.test(e) ? (K[e] = !0) : ((V[e] = !0), !1)))
      );
    }
    function Y(e, t, n, r) {
            ...
            switch (
              ...
              case Qu:
                if (
                  ...
                  e.timeoutHandle = _n(Wc.bind(null, e), o);
                  break;
                }
                Wc(e);
                break;
              case $u:
                ...
                if (
                  ...
                  e.timeoutHandle = _n(Wc.bind(null, e), r);
                  break;
                }
                Wc(e);
                break;
              case Zu:
                if (1073741823 !== oc && null !== ac) {
                  ...
                  if (
                    ...
                    pl(e, n), (e.timeoutHandle = _n(Wc.bind(null, e), r));
                    break;
                  }
                }
                Wc(e);
  ...
  zlVK: function(e, t, n) {
        ...
        return (
          i.Children.forEach(r, function(e) {
            if (null === c && i.isValidElement(e)) {
              ...
              c = r
                ? u.matchPath(a.pathname, h(h({}, e.props), {}, { path: r }))
                : t.match;
            }
          }),
          c
    ...
    function C(e) {
      ...
      if (u) {
        var l = n.isServer ? {} : window.g_initialProps,
          ...
          f = a.createElement(u, s, o);
        if (c) {
          var p = c.length - 1;
          while (p >= 0) (f = i.createElement(c[p], s, f)), (p -= 1);
        }
        return f;
      }
      return o;
    ...
    function _(e) {
      var t = e.plugin.applyPlugins({
        type: u.ApplyPluginsType.modify,
        key: 'rootContainer',
        initialValue: a.createElement(R, {
          history: e.history,
          routes: e.routes,
          plugin: e.plugin,
          ssrProps: e.ssrProps,
